...
<h5>Update Book Info</h5>
	<form:form action="/bookmanagement/edit" method="post" modelAttribute="book">
	<form:label path="code">Book Code  </form:label>
	
	<div class="form-floating mb-3 mt-3">
	<form:input type="hidden" class="form-control" placeholder="Enter Code" path="code"/>
	...
	<div class="form-floating mb-3 mt-3">
		<form:input type="text" class="form-control" placeholder="Enter Author" path="author"/>
		<form:label path="author">Author</form:label>
		<form:errors path="author" cssClass="error"></form:errors>
	
	</div>
	<div>
	<input type="submit" class="btn btn-info" value="Update Book"></div>
	</form:form>
</body>
</html>